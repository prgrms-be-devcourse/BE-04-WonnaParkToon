...
import com.wonnapark.wnpserver.domain.oauth.infrastructure.KakaoToken;
...
public class KakaoApiClient implements OAuthApiClient {
    ...
    public String requestAccessToken(OAuthLoginRequest param) {
        String url = oauthProperties.getKakao().getUrl().getRequestTokenUrl();
    ...
    public OAuthInfoResponse requestOauthInfo(String accessToken) {
        String url = oauthProperties.getKakao().getUrl().getRequestInfoUrl();
